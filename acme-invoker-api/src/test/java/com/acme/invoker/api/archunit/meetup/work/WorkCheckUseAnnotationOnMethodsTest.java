...
//	}
//)
public class WorkCheckUseAnnotationOnMethodsTest {
...
//		rule.check(classes);
	...
	public static void constant_classes_should_be_final(JavaClasses classes) {
		...
		//WorkExampleCatalogConstantArchitectureRule.constant_classes_should_have_names_ending_with_the_word_constant.check(classes);
	}
