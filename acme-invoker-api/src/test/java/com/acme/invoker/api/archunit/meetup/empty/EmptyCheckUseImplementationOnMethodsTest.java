...
public class EmptyCheckUseImplementationOnMethodsTest {
	...
	public void constant_classes_should_have_names_ending_with_the_word_constant_4() {
		...
		// EmptyExampleCatalogConstantArchitectureRule.constant_classes_should_have_names_ending_with_the_word_constant.check(IMPORTED_CLASSES);
